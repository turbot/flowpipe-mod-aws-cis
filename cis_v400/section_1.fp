...
pipeline "cis_v400_1_12" {
  ...
  step "pipeline" "run_pipeline" {
    ...
    loop {
      until = loop.index >= (length(keys(local.cis_v400_1_12_pipelines))-1)
    }

    pipeline = local.cis_v400_1_12_pipelines[keys(local.cis_v400_1_12_pipelines)[loop.index]]
...
pipeline "cis_v400_1_16" {
  ...
  step "pipeline" "run_pipeline" {
    ...
    loop {
      until = loop.index >= (length(keys(local.cis_v400_1_16_pipelines))-1)
    }

    pipeline = local.cis_v400_1_16_pipelines[keys(local.cis_v400_1_16_pipelines)[loop.index]]
...
pipeline "cis_v400_1_22" {
  ...
  step "pipeline" "run_pipeline" {
    ...
    loop {
      until = loop.index >= (length(keys(local.cis_v400_1_22_pipelines))-1)
    }

    pipeline = local.cis_v400_1_22_pipelines[keys(local.cis_v400_1_22_pipelines)[loop.index]]
